...
namespace YahalomUIToolKitPackage.Runtime.BasicRadio
{
    [UxmlElement]
    public partial class BasicRadioGroup : VisualElement
    {
        ...
        public YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio SelectedRadio =>
        ...
        private readonly List<YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio> _radios = new();
        ...
        private void Initialize()
        {
            ...
            this.Query<YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio>().ForEach(RegisterRadio);
        ...
        private void RegisterRadio(YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio radio)
        {
            if (radio == null)
                return;
        ...
        private void RebuildFromChoices()
        {
            ...
            {
                YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio radio = new YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio
                {
                    Text = choice
                };
        ...
        private void OnRadioSelected(YahalomUIToolKitPackage.Runtime.BasicRadio.BasicRadio radio)
        {
            if (_isUpdating)
                return;
